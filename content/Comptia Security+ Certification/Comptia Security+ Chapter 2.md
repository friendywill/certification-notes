...
What are the different [[threat actor|threat actors]]?
What are the different [[threat actor classifications]]?
...
Explain the different [[threat actor attributes]] and the [[threat actor motivations]].
Explain how the different [[threat actor attributes]] causes [[threat actor|threat actors]] to differentiate.
What are [[threat vectors]] and [[attack surfaces]]?
How are the different [[threat vectors]] exploitable?
What increases or decreases [[attack surfaces]]?
What are the different [[types of vulnerabilities]]?
What are the different activities to [[vulnerability management|manage vulnerabilities]]?
How does [[vulnerability management]] help deal with risks?
How is [[shadow IT]] defined?
What are the different [[attacker motivations]]?
What are the different [[threat vectors]]? And what are the means for using those vectors?
What are the different [[attack surfaces]], how do they relate to [[threat vectors]]?
Define [[threat intelligence]]
What are the different sources for [[threat intelligence]]? Explain each
...
What are [[standardized security languages]] for [[threat indicator management]]?
What is [[OASIS]]?
What are [[ISACS]]?
# Read
